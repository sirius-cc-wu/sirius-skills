...
4. When the target should execute on its own branch and checkout,
   ...
   dedicated worktree, register it in the shared pool, and later hand the
   branch off to PR creation.
