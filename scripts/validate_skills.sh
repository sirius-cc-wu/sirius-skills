...
analysis_design_skill="$root/skills/iterative-risk-driven-analysis-design/SKILL.md"
analysis_design_metadata="$root/skills/iterative-risk-driven-analysis-design/agents/openai.yaml"
execution_skill="$root/skills/run-development-iteration/SKILL.md"
...
frontmatter_reference="$root/skills/iterative-risk-driven-analysis-design/references/markdown-artifact-frontmatter.md"
...
test -f "$analysis_design_metadata" || fail "iterative-risk-driven-analysis-design missing agents/openai.yaml"
grep -Fq '$iterative-risk-driven-analysis-design' "$analysis_design_metadata" || fail "iterative analysis/design metadata missing skill invocation"
grep -q "^## Iteration Plan Template$" "$analysis_design_skill" || fail "iterative analysis/design skill missing iteration template"
grep -q "^## Artifact Durability$" "$analysis_design_skill" || fail "iterative analysis/design skill missing artifact durability guidance"
grep -q "run-development-iteration" "$analysis_design_skill" || fail "iterative analysis/design skill missing execution handoff"
grep -q "^## Prepared Analysis Candidate Mode$" "$execution_skill" || fail "run-development-iteration missing prepared analysis mode"
...
template_types=(
  ...
  "iterative-risk-driven-analysis-design|Iteration Record"
