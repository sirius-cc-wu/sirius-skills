...
managed_skills := "iterative-up-analysis-design use-case-modeling domain-modeling system-sequence-diagrams operation-contracts grasp-responsibility-design use-case-realization uml-class-diagram-design design-pattern-application"
