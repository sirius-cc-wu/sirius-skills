...
| Addy Osmani's `interview-me`, `idea-refine`, and `documentation-and-adrs` at revision [`5a1b82d`](https://github.com/addyosmani/agent-skills/tree/5a1b82d6445d1e2f0abeea1072851419a50c0e5c) | `assess-development-input`, `design-repository-artifact-layout` | Optional requester-intent clarification, candidate-direction refinement, idea/proposal lifecycle equivalence, and handoff to repository-local accepted decision records |
| Sirius durable-artifact and repository-navigation practice | `design-repository-artifact-layout`, `iterative-up-analysis-design` | Repository-first convention discovery, artifact lifecycle separation, minimal layouts, canonical paths, linking, migration, and durable current knowledge versus historical iteration records |
