...
| Sirius proposal governance and accumulated technical proposal practice | `author-software-proposal` | Canonical proposal ownership, decision-oriented authoring, evidence-versus-intent separation, lifecycle boundaries, and acceptance evidence |
...
| Gojko Adzic, *Specification by Example* | `requirements-synthesis-validation`, `implementation-slice-briefing` | Collaborative examples, concrete playback, validation, traceable requirement knowledge, and executable handoff |
