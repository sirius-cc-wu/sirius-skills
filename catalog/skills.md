...
| `author-software-proposal` | Decision-oriented proposal authoring, evidence-versus-intent separation, progressive disclosure, alternatives, risks, open decisions, and acceptance evidence | Draft or substantively revised software proposal | Frames a consequential change for review without accepting, implementing, committing, or publishing it |
