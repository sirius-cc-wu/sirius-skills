...
| `rewrite-technical-artifacts` | Progressive disclosure, reader orientation, representative scenarios, canonical-rule linking, and semantic inventories | Revised canonical technical artifact or review | Improves reading order without changing normative meaning, evidence, identifiers, lifecycle, or traceability |
