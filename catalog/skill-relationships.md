...
The gray nodes belong to the pinned Addy Osmani external
collection. They are not part of the Sirius catalog or named profiles.
...
findings can expose missing contracts or evidence; they do not recover undocumented
design. Route readability and local-complexity findings to
`code-simplification`.
