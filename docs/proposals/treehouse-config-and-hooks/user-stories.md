# User Stories: Treehouse Config And Hooks

- **TCH-01 (M)**: As a project maintainer, I want a repo config file with safe
  defaults so I can adopt treehouse without manual bootstrapping.
