...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| EW-01 | M | Resolve one planning scope into one ordered execution backlog | I1, I2 | EW-MSE-01-scope-and-backlog-resolution, EW-MSE-02-sequential-slice-orchestration | Scope resolution, planned-slice backlog selection, one-slice-at-a-time bootstrap |  |  | Extends slice bootstrap from one explicit work item to one ordered backlog |
