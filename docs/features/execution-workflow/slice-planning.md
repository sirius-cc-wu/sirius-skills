...
| EW-04-relations | EW-04 | Record durable slice relations | Maintain relation types, scoping, and reciprocal integrity. | `skills/execution-driver/scripts/manage_execution.py` | primary | `pytest -q skills/execution-driver/tests/test_manage_execution.py` | create slice | EW-04-review | yes |
