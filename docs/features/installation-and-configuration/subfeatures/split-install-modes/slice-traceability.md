...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| SIM-01 | M | Add a source-linked local install path | I1 | SIM-01-local-helper | Helper |  |  | Establishes the deterministic local symlink helper before other install-mode work depends on it |
