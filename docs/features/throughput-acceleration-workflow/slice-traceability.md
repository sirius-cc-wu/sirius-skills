...
| TAW-03 | L | Resume interrupted accelerator runs from durable checkpoint context | I1 | taw-runtime-foundation | shared runtime stores, locking, packaged runtime sync |  |  | Establishes supplemental runtime support without changing workflow truth ownership |
