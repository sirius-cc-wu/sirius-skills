...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| CAM-03 | M | Report active, reviewed, stale, and closed workflow artifacts | I1 | CAM-03-artifact-state-report | Shared reporting records, grouped summaries, stale classification, skill/docs/tests |  |  | One read-only slice that turns durable metadata into operational views |
