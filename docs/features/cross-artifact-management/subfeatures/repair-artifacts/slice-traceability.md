...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| CAM-04 | M | Repair registry and readme drift from durable artifact metadata | I1 | CAM-04-registry-drift-repair | Rebuilt rows, dry-run repair plans, apply mode, skill/docs/tests |  |  | One conservative slice focused on active registry regeneration |
