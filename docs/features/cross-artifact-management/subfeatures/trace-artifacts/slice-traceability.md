...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| CAM-02 | L | Trace lineage across proposals, features, subfeatures, planned slices, and execution slices | I1 | tat-trace-artifact-lineage | Shared inventory reuse, traceability parser, lineage graph, skill/docs/tests |  | tat-trace-artifact-lineage | One cohesive slice that builds the reusable lineage model for later reporting |
