...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| CAM-05 | M | Report archive candidates and archive one closed slice safely | I1 | arc-safe-slice-archival | Candidate discovery, explicit slice archival, skill/docs/tests |  | arc-safe-slice-archival | One conservative slice that adds safe archival without broad cleanup side effects |
