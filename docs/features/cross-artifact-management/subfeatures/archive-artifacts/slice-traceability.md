...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| CAM-05 | M | Report archive candidates and archive one closed slice safely | I1 | CAM-05-safe-slice-archival | Candidate discovery, explicit slice archival, skill/docs/tests |  |  | One conservative slice that adds safe archival without broad cleanup side effects |
