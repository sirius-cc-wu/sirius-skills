...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| CAM-01 | L | Audit artifact health across proposals, features, subfeatures, and slices | I1 | aat-cross-artifact-audit | Inventory helper, delegated validators, cross-artifact checks, skill/docs/tests |  | aat-cross-artifact-audit | One cohesive slice that establishes the shared finding model for later subfeatures |
