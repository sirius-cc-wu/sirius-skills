...
| WSC-02 | M | Share one reconciliation model across maintenance workflows | I1 | WSC-02-maintenance-adoption | Audit, Trace, Repair, Report, Install packaging | WSC-02-shared-library |  | Second execution packet adopts the shared library across maintenance skills and wires managed install/package sync for self-contained skill copies. |
