...
| PFW-05-config-support | PFW-05 | Support configurable proposal storage | Extend `.skills/planning.json` and configure-project defaults with `proposal_dir`. | `.skills/planning.json`, `skills/configure-project/` | primary | `pytest -q skills/configure-project/tests/test_configure_project.py` | completed | PFW-01-proposal-registry | yes |
| PFW-04-proposal-promotion | PFW-04 | Promote accepted proposals into features | Add explicit promotion from proposal staging into canonical feature planning. | `skills/propose/scripts/manage_proposals.py` | primary | `pytest -q skills/propose/tests/test_manage_proposals.py` | completed | PFW-02-guide-routing, PFW-03-proposal-lifecycle, PFW-05-config-support | yes |
