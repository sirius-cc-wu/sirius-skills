...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| fcr-declaration-contract | FCR-01 | Require consolidation declarations in planning authoring | Update planning authoring guidance and scaffolding so workflow-shaping changes declare disposition, targets, artifact movement, and user-facing simplification. | `skills/discover/`, `skills/add-subfeature/` | primary | `rg -n "consolidation|historical|simplification" /home/ccwu/.agents/skills/discover/SKILL.md /home/ccwu/.agents/skills/add-subfeature/SKILL.md /home/ccwu/.agents/sirius manage-subfeatures` | create slice |  | yes |
