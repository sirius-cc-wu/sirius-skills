...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| pw-registry | PW-01 | Initialize planning registry and metadata | Manage planning config, registry, and `.planning-meta.json` lifecycle. | `sirius manage-planning` | primary | `pytest -q skills/guide-planning/tests/test_manage_planning.py` | create slice |  | yes |
| pw-gates | PW-02 | Enforce planning readiness gates | Validate required artifacts across discovery and design transitions. | `sirius manage-planning` | primary | `pytest -q skills/guide-planning/tests/test_manage_planning.py` | create slice | pw-registry | yes |
