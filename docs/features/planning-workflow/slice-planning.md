...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| PW-01-registry | PW-01 | Initialize planning registry and metadata | Manage planning config, registry, and `.planning-meta.json` lifecycle. | `skills/guide-planning/scripts/manage_planning.py` | primary | `pytest -q skills/planning-driver/tests/test_manage_planning.py` | create slice |  | yes |
| PW-02-gates | PW-02 | Enforce planning readiness gates | Validate required artifacts across discovery and design transitions. | `skills/guide-planning/scripts/manage_planning.py` | primary | `pytest -q skills/planning-driver/tests/test_manage_planning.py` | create slice | PW-01-registry | yes |
...
| PW-04-review-readiness | PW-04 | Record planning review readiness | Require review notes and validate reviewed state before handoff. | `skills/review-planning/`, `manage_planning.py` | primary | `pytest -q skills/planning-driver/tests/test_manage_planning.py` | create slice | PW-03-breakdown-guidance | yes |
