...
4.  **Execute**: Use `spec-driver`, `define`, and `plan` to create task-scoped execution artifacts, including PlantUML detailed design when it clarifies implementation.
