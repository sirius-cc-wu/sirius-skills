...
architecture-decision lifecycle, use external `documentation-and-adrs` with the
`all` installation or follow repository-native ADR guidance. Do not create a
duplicate pattern record.
