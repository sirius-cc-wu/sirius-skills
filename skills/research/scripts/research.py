...
def main() -> int:
    ...
    try:
        ...
        content = build_content(
            ...
            target_path=normalize_relpath(target_dir, Path(scope_context.repo_root)),
            ...
            wiki_root=normalize_relpath(wiki_root, Path(scope_context.repo_root)),
    ...
    print(
        ...
        f"'{normalize_relpath(output_path, Path(scope_context.repo_root))}'."
    )
    return 0
