...
5. Stop after the local artifact is updated. Downstream routing into
   `discover`, `design`, `review-planning`, or reusable wiki-page mutation
   belongs to later workflow steps.
...
written there, record that explicitly:
