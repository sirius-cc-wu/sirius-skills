...
1. Review implementation and validation evidence against the active slice's `blueprint.md` and any optional legacy `brief.md`.
...
- optional legacy `<slice_path>/brief.md`
...
2. Read `blueprint.md`, optional legacy `brief.md`, changed code, and available validation evidence.
3. Compare the implementation with the slice-scoped requirements and validation plan.
4. Update `blueprint.md`, optional legacy `brief.md`, or upstream planning guidance when the review reveals a durable context gap.
