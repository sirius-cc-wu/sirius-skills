...
ENGINE_SCRIPT = Path(__file__).resolve().parents[3] / "src" / "sirius_skills" / "commands" / "metrics_engine.py"
CLI_SCRIPT = Path(__file__).resolve().parents[3] / "src" / "sirius_skills" / "commands" / "measure_artifacts.py"
STORE_SCRIPT = Path(__file__).resolve().parents[3] / "src" / "sirius_skills" / "commands" / "metrics_store.py"
PLANNING_SCRIPT = (
