...
5. Run `sirius manage-planning sync-status <feature-selector> --through design_ready` when the feature requires UI flow so metadata catches up once the design packet is complete.
