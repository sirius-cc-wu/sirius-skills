...
SCRIPT_PATH = Path(__file__).resolve().parents[1] / "scripts" / "scaffold_design.py"
...
def test_scaffold_design_creates_feature_scaffold(tmp_path, monkeypatch):
    ...
    assert "Scaffold generated by `skills/design/scripts/scaffold_design.py`." in content
