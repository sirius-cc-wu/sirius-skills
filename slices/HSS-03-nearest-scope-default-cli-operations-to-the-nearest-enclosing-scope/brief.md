...
**Slice**: `HSS-03-nearest-scope-default-cli-operations-to-the-nearest-enclosing-scope`
**Created**: 2026-04-03  
**Status**: Draft  
**Input**: "HSS-03-nearest-scope Default CLI operations to the nearest enclosing scope"
...
- **Source Story / Increment / Slice**: HSS-03 / I1 / HSS-03-nearest-scope
