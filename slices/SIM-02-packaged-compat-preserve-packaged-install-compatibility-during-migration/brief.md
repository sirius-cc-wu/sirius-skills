...
**Slice**: `SIM-02-packaged-compat`  
**Created**: 2026-04-19  
**Status**: Draft  
**Input**: `split-install-modes / SIM-02-packaged-compat`
...
- **Source Story / Increment / Slice**: `SIM-02` / `I2` / `SIM-02-packaged-compat`
...
- **A1**: `SIM-02-packaged-targets` already added working `install-packaged` and `uninstall-packaged` targets.
