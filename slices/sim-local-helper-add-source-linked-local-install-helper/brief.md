...
**Slice**: `sim-local-helper`  
**Created**: 2026-04-19  
**Status**: Draft  
**Input**: `split-install-modes / sim-local-helper`
...
- **Source Story / Increment / Slice**: `SIM-01` / `I1` / `sim-local-helper`
...
- **D2**: `sim-packaged-targets` will perform the later command-surface split; this slice only adds the local helper entrypoints it needs.
