...
**Slice**: `wsc-semantic-preview`  
**Created**: 2026-04-19  
**Status**: Draft  
**Input**: `workflow-state-consistency / wsc-semantic-preview`
...
- **A1**: `wsc-maintenance-adoption` provides the shared workflow-state interpretation that repair and report should reuse for semantic preview findings.
...
- **D1**: `wsc-maintenance-adoption` is complete and remains the prerequisite shared semantic foundation for the repair/report preview behavior.
