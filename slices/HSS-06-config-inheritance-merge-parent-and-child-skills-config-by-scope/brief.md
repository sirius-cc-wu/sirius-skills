...
**Slice**: `HSS-06-config-inheritance-merge-parent-and-child-skills-config-by-scope`
**Created**: 2026-04-03  
**Status**: Draft  
**Input**: "HSS-06-config-inheritance Merge parent and child .skills config by scope"

## 1. Work Item Summary

- **Work Item**: Merge parent and child `.skills` config values through the scope chain with child override precedence.
- **Source Story / Increment / Slice**: HSS-06 / I2 / HSS-06-config-inheritance
...
- **FR-005**: The slice MUST not yet relocate execution registries or slices; that behavior belongs to HSS-06-scoped-execution.
...
- **A2**: Scope-local execution registry placement itself is deferred to HSS-06-scoped-execution even though execution config merging starts here.
