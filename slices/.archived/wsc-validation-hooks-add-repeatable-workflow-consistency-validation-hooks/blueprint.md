...
- Current system context:
  - The repository already has deterministic workflow-state regression coverage
    ...
    guardrails.
  - `wsc-installed-parity` added a shared parity helper and clean/stale
    installed-copy fixtures, while `wsc-transition-guardrails` stabilized
...
- Target files:
  ...
  - `Makefile`
  - `README.md`
- Dependencies: `wsc-transition-guardrails`, `wsc-installed-parity`
- Steps:
