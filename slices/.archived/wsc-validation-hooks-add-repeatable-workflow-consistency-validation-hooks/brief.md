...
**Slice**: `wsc-validation-hooks`  
**Created**: 2026-04-19  
**Status**: Draft  
**Input**: `workflow-state-consistency / wsc-validation-hooks`
...
- **A1**: `wsc-transition-guardrails` and `wsc-installed-parity` already define the workflow consistency behaviors that this slice must keep repeatably validated.
