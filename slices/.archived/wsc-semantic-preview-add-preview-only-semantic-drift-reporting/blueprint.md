...
- Current system context:
  ...
  - Later planned work (`wsc-transition-guardrails`) depends on one stable
...
- Target files:
  ...
  - synced maintenance runtime copies under `skills/repair-artifacts/lib/` and
    `skills/report-artifacts/lib/`
- Dependencies: `wsc-maintenance-adoption`
- Steps:
...
- Review classification:
  ...
  - follow-up improvement outside the active slice:
    - `wsc-transition-guardrails` should reuse the shared
