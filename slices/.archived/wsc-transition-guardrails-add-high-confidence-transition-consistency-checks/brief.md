...
**Created**: 2026-04-19  
**Status**: Draft  
**Input**: `workflow-state-consistency / wsc-transition-guardrails`
...
- **A1**: `wsc-semantic-preview` provides the stable shared semantic finding contract that transition owners should reuse directly.
...
- **D1**: `wsc-semantic-preview` is complete and remains the semantic prerequisite for owner-transition reuse.
