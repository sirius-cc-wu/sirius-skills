...
**Slice**: `hss-promotion-targeting-support-explicit-cross-scope-promotion-targets`
**Created**: 2026-04-03  
**Status**: Draft  
**Input**: "hss-promotion-targeting Support explicit cross-scope promotion targets"
...
- **FR-005**: The slice MUST not change the generic ambiguity-handling contract already established by hss-scope-selection.
...
- **A1**: hss-scope-selection already provides explicit `--scope` for resolving the proposal’s source scope safely.
...
- **D1**: hss-scope-selection is already in place.
