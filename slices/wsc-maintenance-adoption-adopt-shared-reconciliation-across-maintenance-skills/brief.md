...
**Created**: 2026-04-19  
**Status**: Draft  
**Input**: `workflow-state-consistency / wsc-maintenance-adoption`
...
- **A1**: `wsc-shared-library` remains the canonical source of shared workflow-state behavior, and this slice focuses on consumer adoption rather than redefining that contract.
...
- **D1**: `wsc-shared-library` is complete and remains the prerequisite shared semantic foundation for all affected maintenance workflows.
