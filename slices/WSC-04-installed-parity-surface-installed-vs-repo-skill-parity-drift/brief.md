...
**Created**: 2026-04-19  
**Status**: Draft  
**Input**: `workflow-state-consistency / WSC-04-installed-parity`
...
- **Source Story / Increment / Slice**: `WSC-04` / `I3` / `WSC-04-installed-parity`
...
- **A1**: `WSC-02-maintenance-adoption` and `WSC-01-transition-guardrails` have already stabilized the shared runtime and skill-local sync flow enough that parity can compare meaningful installed-vs-repo expectations.
...
- **D1**: `WSC-02-shared-library` remains the prerequisite canonical source for comparing installed copies with repo-local expectations.
