...
**Slice**: `HSS-04-scope-selection-require-explicit-scope-selection-for-ambiguous-lookups`
**Created**: 2026-04-03  
**Status**: Draft  
**Input**: "HSS-04-scope-selection Require explicit scope selection for ambiguous lookups"

## 1. Work Item Summary

- **Work Item**: Detect ambiguous multi-scope feature and proposal lookups and require explicit scope selection.
- **Source Story / Increment / Slice**: HSS-04 / I2 / HSS-04-scope-selection
...
- **A2**: Explicit scope selection in this slice covers generic lookup commands; explicit cross-scope promotion targets belong to HSS-04-promotion-targeting.
