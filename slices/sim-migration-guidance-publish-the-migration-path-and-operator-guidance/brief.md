...
**Slice**: `sim-migration-guidance`  
**Created**: 2026-04-19  
**Status**: Draft  
**Input**: `split-install-modes / sim-migration-guidance`
...
- **Source Story / Increment / Slice**: `SIM-04` / `I3` / `sim-migration-guidance`
...
- **D2**: The explicit packaged parity flag added in `sim-parity-scope` is the authoritative operator contract for parity validation.
