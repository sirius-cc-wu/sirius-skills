...
**Created**: 2026-04-19  
**Status**: Draft  
**Input**: `split-install-modes / SIM-03-runtime-scope`
...
- **Source Story / Increment / Slice**: `SIM-03` / `I3` / `SIM-03-runtime-scope`
...
- **A1**: `SIM-02-packaged-compat` has already clarified that `install-packaged` is the explicit packaged path and `install` remains an alias.
